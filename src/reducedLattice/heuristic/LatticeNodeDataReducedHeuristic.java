...
public class LatticeNodeDataReducedHeuristic implements ILatticeNodeData {
	...
	// usage: for root node;
	public LatticeNodeDataReducedHeuristic(Set<String> set) {
	 ...
	 */
	public LatticeNodeDataReducedHeuristic(PatternNode sourceAbstractPatternNode,
	 ...
	 * @param direction
	 */
	public LatticeNodeDataReducedHeuristic(ListenableDirectedGraph<PatternNode, DefaultLabeledEdge> newAbsPattern,
	...
	private boolean twoPatternNodesAreSame(PatternNode unexpandedPatternNode,
			...
			LatticeNodeDataReducedHeuristic LatticeNodeData) {
