...
//
//public class LatticeReducedHeuristic implements ILattice {
...
//	 * @throws Exception
//	 */
//	public LatticeReducedHeuristic(String focusSetPath, int maxAllowedHops, int maxAllowedEdges,
...
//
//			if (lhsProcessingNode.getData().getTotalSupportFrequency() < supportThreshold)
//				continue;
//
...
//
//				lhsProcessingNode.getData().initRHSQueueFromChildrenMaxRules(this, lhsProcessingNode);
//
...
//
//					if (rhsProcessingNode.getData().getTotalSupportFrequency() < supportThreshold) {
//						continue;
//					}
//
...
//						// verify it
//						DualSimulationHandler.gtarVerification(currentRule, minTimestamp, maxTimestamp, deltaT);
...
//				if (newChild.getData().getTotalSupportFrequency() < supportThreshold) {
//					System.out.println();
//				}
