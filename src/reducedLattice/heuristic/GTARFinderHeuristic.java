...
public class GTARFinderHeuristic {
	...
	public LatticeReducedHeuristicOpt lattice;
	...
	public GTARFinderHeuristic(String[] args) throws Exception {
	...
	public GTARFinderHeuristic(String focusSetPath, int maxHops, int maxEdges, String dataGraphPath, boolean debugMode,
	...
	public void findGTARs() throws Exception {
		...
		// if (!rules.isEmpty()) {
		TimeLogger.LogTime("GTAR_Reduced_Heuristic_Opt_" + DummyProperties.hasOptimization + ".csv", true, timeInfos);
		// }
		...
		if (!rules.isEmpty()) {
			DummyFunctions.printQualityVsTime("Heuristic", lattice.whatIsFocus, numberOfAllPatterns, maxAllowedHops,
	...
	private void loadDataGraph() throws Exception {
		...
		dataGraph = new GraphDatabaseFactory().newEmbeddedDatabaseBuilder(storeDir)// .setConfig("cache_type",
																					// "none")
		...
		// init lattice
		lattice = new LatticeReducedHeuristicOpt(focusSetPath, maxAllowedHops, maxAllowedEdges, dataGraph, debugMode,
	...
	public static void main(String[] args) throws Exception {
		GTARFinderHeuristic temporalGraphAssociationRuleFinder = new GTARFinderHeuristic(args);
