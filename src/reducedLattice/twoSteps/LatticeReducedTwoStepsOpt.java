...
public class LatticeReducedTwoStepsOpt implements ILattice {
	 ...
	 * @throws Exception
	 */
	public LatticeReducedTwoStepsOpt(String focusSetPath, int maxAllowedHops, int maxAllowedEdges,
	...
	private void outgoingExpansion(LatticeNode<ILatticeNodeData> tempProcessingNode,
		...
		for (String otherNodeLabelRelType : seenRelTypeOutgoingSet.keySet()) {
			...
			if (timebound > 0 && ((System.nanoTime() - this.startTime) / 1e6) > timebound) {
				timeout = true;
				return;
			}
	...
	private LatticeNode<ILatticeNodeData> createNewLatticeNode(LatticeNode<ILatticeNodeData> tempProcessingNode,
		...
		// if (numberOfPatternsInLattice == 29) {
		// System.out.println();
		// }
