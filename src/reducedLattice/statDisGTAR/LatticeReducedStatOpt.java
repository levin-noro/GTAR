...
public class LatticeReducedStatOpt implements ILattice {
	 ...
	 * @throws Exception
	 */
	public LatticeReducedStatOpt(String focusSetPath, int maxAllowedHops, int maxAllowedEdges,
	...
	private LatticeNode<ILatticeNodeData> initializeLattice() throws Exception {
		...
		ILatticeNodeData emptyPTRootData = new LatticeNodeDataReducedStat(focusLabelSet);
		...
		ILatticeNodeData firstLevelChildData = new LatticeNodeDataReducedStat(focusNode, dgGraphMatchNodes,
		...
		labelAdjacencyIndexer.generateTemporalNeighborhoodIndexForStat(maxAllowedHops, whatIsFocus, this.minTimestamp,
				this.maxTimestamp);
		if (DummyProperties.debugMode)
			System.out.println(
	...
	private void createFromOldDangling(PatternNode oldDanglingPatternNode, HashSet<Integer> remainingNodeIds,
		...
		StatDualSimulationHandler.computeMatchSetOfAPatternStat(dataGraph, tempProcessingNode, this, minTimestamp,
				maxTimestamp);
	...
	private void innerQueueNodePostProcessing(LatticeNode<ILatticeNodeData> lhsProcessingNode,
		...
		if (!newChild.getData().isVerified())
			...
			StatDualSimulationHandler.computeMatchSetOfAPatternStat(dataGraph, newChild, this, minTimestamp, maxTimestamp);
	...
	private LatticeNode<ILatticeNodeData> createNewLatticeNode(LatticeNode<ILatticeNodeData> tempProcessingNode,
		...
		ILatticeNodeData LatticeNodeData = new LatticeNodeDataReducedStat(newPatternGraph,
