...
public class FixedSettingExperimenter {
							...
							for (int t : deltaTs) {
								...
								for (int exp = 0; exp < numberOfSameExperiments; exp++) {
									...
									String settingStr = " focus was " + line + ", h:" + h + " , e:" + e + ", s:" + s
											+ ", c:" + c + ", deltaT:" + t;
									System.out.println("OPT GTARFinderHeuristic Finder: exp " + exp + settingStr);
								...
								String settingStr = " focus was " + line + ",h:" + h + " , e:" + e + ", s:" + s + ", c:"
										+ c + ", deltaT:" + t;

								System.out.println("NON-OPT GTARFinderTwoSteps Finder: exp " + 1 + settingStr);
								...
								settingStr = " focus was " + line + ",h:" + h + " , e:" + e + ", s:" + s + ", c:" + c
										+ ", deltaT:" + t;
								System.out.println("NON-OPT GTARFinderHeuristic Finder: exp " + 1 + settingStr);
